...
export default function SizeControl({ width, height, onChange }: SizeControlProps) {
  return (
    <div className="space-y-4 lg:space-y-5">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative group">
            <input
              ...
              className="w-full px-4 py-2 lg:py-3 border border-gray-200 dark:border-gray-700 rounded-2xl bg-gray-50 dark:bg-gray-800/50 focus:bg-white dark:focus:bg-gray-800 focus:ring-2 focus:ring-black/5 dark:focus:ring-white/10 focus:border-gray-300 dark:focus:border-gray-600 transition-all font-mono text-lg font-medium text-gray-900 dark:text-white [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
            />
      ...
      {/* Preset Sizes */}
      <div>
        <span className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-2 block uppercase tracking-wider ml-1">Quick Presets</span>
          ...
          {PRESET_SIZES.map((size) => {
            ...
            return (
              <button
                ...
                className={`
                  px-3 py-2 text-sm rounded-xl font-medium transition-all duration-200 flex items-center justify-center gap-2 border relative overflow-hidden group
                  ${isActive 
